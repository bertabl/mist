...
myFile = ROOT.TFile.Open("/Users/bertabeltran/SMUT/data/TestingScintillators/Scint_42_43_44_45/FILTERED/HcompassF_Scint_42_43_44_45_20240502_092834.root")
myFile.ls()
dir = myFile.GetDirectory("Energy");


#scintialltors that we have tested in this run from Chn0 to Chan 3
scint_list=[42,43,44,45]
